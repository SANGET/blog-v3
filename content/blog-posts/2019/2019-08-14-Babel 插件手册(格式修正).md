...
date: 2019-08-14
layout: post
title: Babel 插件手册(格式修正)
keywords: [babel 插件]
description: Babel 插件手册(格式修正)
tags: 
  - 记录
---
...
> 请注意，有时在节点上可以定制的属性比``构建器数组包含的属性更多。 这是为了防止生成器有太多的参数。 在这些情况下，您需要手动设置属性。 一个例子是<class> ClassMethod .
</blockquote>
...
这个包使测试插件更容易。 如果您熟悉ESLint的 [RuleTester][RuleTesterUrl] 您应该对这是熟悉的。 您可以看看[the docs][thisDocUrl]去充分了解可能的情况，但这里有一个简单的例子：
...
[RuleTesterUrl]: http://eslint.org/docs/developer-guide/working-with-rules#rule-unit-tests
[thisDocUrl]: https://github.com/kentcdodds/babel-plugin-tester/blob/master/README.md
