...
- 公司简介：toB 综合技术提供商，为集团旗下的市场部门提供业务系统、产品研发服务，包括「交易系统」、「财务系统」、「游戏」、「IM 服务」
- 行业介绍：地产、餐饮、游戏动画
- 职位：前端组负责人
...
- 职位：软件工程师
- 职责：负责中国海关内部业务系统的原型制作，.NET 的 web API 研发、系统前端模块研发
...
- 基于 @deer-ui 的应用：
  ...
  - [react-ui-doc][react-ui-doc] 使用 mdx 编写 UI Components 文档的生成器
...
> Synergy88 - 业务应用 - 「服务已下线，原 zan.com」
...
> Synergy88 - 业务应用 - 「服务已下线，使用 Jenkins 代替」
...
- BlogHelper: 基于 serverless 的博客助理服务，提供点赞（like），访客记录（visitor），文章评论（comment）等常用功能
